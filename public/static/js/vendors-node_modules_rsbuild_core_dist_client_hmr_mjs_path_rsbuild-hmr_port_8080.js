(self['webpackChunkb'] = self['webpackChunkb'] || []).push([["vendors-node_modules_rsbuild_core_dist_client_hmr_mjs_path_rsbuild-hmr_port_8080"], {
"./node_modules/@rsbuild/core/dist/client/hmr.mjs?&path=/rsbuild-hmr&port=8080": (function (__webpack_module__, __webpack_exports__, __webpack_require__) {
"use strict";
...
function canApplyUpdates() {
    return __webpack_module__.hot.status() === "idle";
}
function tryApplyUpdates() {
    ...
    __webpack_module__.hot.check(true).then(function(updatedModules) {
...
function _onClose() {
    _onClose = _async_to_generator(function() {
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    if (typeof console !== "undefined" && typeof console.info === "function") console.info("[HMR] disconnected. Attempting to reconnect.");
                    removeListeners();
                    return [
                        4,
                        sleep(1e3)
                ...
                case 1:
                    ...
                    if (retry_counter > MAX_RETRIES) {
                        if (typeof console !== "undefined" && typeof console.info === "function") console.info("[HMR] Unable to establish a connection after exceeding the maximum retry attempts.");
                        retry_counter = 0;
                        return [
                            2
                        ];
...
//# sourceMappingURL=vendors-node_modules_rsbuild_core_dist_client_hmr_mjs_path_rsbuild-hmr_port_8080.js.map